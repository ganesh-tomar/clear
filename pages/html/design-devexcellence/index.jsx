...
import Logocontentgrid from '../../../components/Logocontentgrid';
...
export default function casestudiesdetail({ menuItems }) {
    ...
    return (
        <Layout footerMenu={menuItems}>
            <NextSeo
                title="Design Devexcellence"
                description="ClearDigital"
            />
            <BannerThirdLevel1 content={'designdevexprience'} pSize="medium" />
            <ContentGrid introName="design" cards="driving" min={'full'} />
            <Cta contentName={'work'} heading={true} />
            <Imagewithcontent contentname={'data'} />
            <Logocontentgrid />
            {/* <TabSlider /> */}
