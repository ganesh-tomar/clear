    ...
    <section className="introwithcards bg-gray">
      <div className="container">
        ...
        <div className="wrapper w-colThreeWrapper flex flex-wrap ml-[-1.5rem] sm:ml-0 sm:w-full">
          <div className="card group relative w-[calc(33.33%-3rem)] lg:w-[calc(50%-3rem)] sm:!w-full lg:mb-[2rem]  mx-[1.5rem] min-h-[45rem] lg:min-h-[34rem] bg-[#FFFFFF] pt-[5rem] pr-[4rem] pb-[11rem] pl-[5rem] lg:pt-[4rem] lg:pr-[4rem] lg:pl-[4rem] sm:mx-0 sm:!min-h-[30rem] sm:!px-[2rem]">
            <Link className='redirect' href="/" target='_blank'>.</Link>
            <h4 className='mb-[1rem] sm:text-[20px]'>Lorem ipsum dolor sit amet consectetur. Aliquam ac semper massa luctus pellentesque orci.</h4>
            <p>Torem ipsum dolor sit amet, consectetur adipiscing at elit.</p>
