...
// import { GET_WHITEPAPER_BY_SLUG } from '../../../graphql/posts';
...
//   try {
//     // Fetch the specific whitepaper content by slug
//     const { data: whitepaperData } = await apolloClient.query({
//       query: GET_WHITEPAPER_BY_SLUG,
//       variables: { slug },
//     });

//     // If whitepaper is not found, return 404
//     if (!whitepaperData.whitepaperBy) {
//       return {
//         notFound: true,
//       };
//     }
...
//     // Exclude the current post (whitepaper) from the list of latest posts
//     const recentPosts = latestPosts.filter((latestPost) => latestPost.slug !== slug).slice(0, 3);

//     // Return the whitepaper data and recent posts as props
//     return {
//       props: {
//         whitepaper: whitepaperData.whitepaperBy,
...
// const WhitepaperDetail = ({ whitepaper, recentPosts, formID }) => {
...
// 					<meta
// 						name="description"
// 						content={`whitepaper created by ${whitepaper.author?.node?.name}`}
// 					/>
// 				</Head>
...
// 							<Image
// 								alt={whitepaper?.featuredImage?.node.altText}
// 								width="1600"
// 								height="1090"
// 								className="object-bottom xxl-down:object-center"
// 								src={
// 									whitepaper?.featuredImage?.node?.mediaItemUrl ||
// 									'/default-image.jpg'
// 								}
// 							/>
// 						</div>
...
// 							<h1 className="h2 text-white">{whitepaper?.title}</h1>
// 						</div>
// 					</div>
// 				</section>
...
//                           <Image
//                             src={
//                               whitepaper?.author?.node?.userProfile?.userAvatar
//                                 ?.sourceUrl
//                             }
//                             width={2000}
//                             height={2000}
...
//                             By{' '}
//                             <Link
//                               href={`/author/${whitepaper?.author?.node?.name}`}
//                               className="underline"
//                             >
//                               {whitepaper?.author?.node?.firstName}{' '}
//                               {whitepaper?.author?.node?.lastName}
//                             </Link>
//                           </p>
...
//                           <Link
//                             className="redirect"
//                             href={`https://www.linkedin.com/shareArticle?mini=true&url=${fullUrl}&title=${whitepaper.title}&summary=&source=${fullUrl}`}
//                             target="_blank"
//                           >
//                             .
//                           </Link>
...
//                           <Link
//                             className="redirect"
//                             href={`https://www.facebook.com/sharer.php?u=${fullUrl}&t=${whitepaper.title}`}
//                             target="_blank"
//                           >
//                             .
//                           </Link>
