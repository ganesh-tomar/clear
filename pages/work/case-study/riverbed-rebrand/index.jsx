...
import { heroBanner, imageBlade, imageGrid, brandedblade, imageGridVersion, introduction, logoWithContent, redirect, footerCta } from './data.js'
...
export default function Index() {
  ...
  return (
    <Layout>
           <NextSeo
                title="Riverbed: Digital experience innovation & acceleration"
                description="Riverbed has been at the forefront of digital innovation for over two decades,"  
            />
