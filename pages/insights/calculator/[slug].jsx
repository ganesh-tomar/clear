...
//         <meta name="description" content={`Calculator created by ${calculator.author?.node?.name}`} />
//       </Head>
...
//               src={calculator?.featuredImage?.node?.mediaItemUrl || '/default-image.jpg'}
//             />
//           </div>
//         }
...
//                       <Image
//                         src={calculator?.author?.node?.userProfile?.userAvatar?.sourceUrl}
//                         width={2000}
//                         height={2000}
//                         className="w-full h-full object-contain rounded-full"
//                         alt={calculator?.author?.node?.userProfile?.userAvatar?.altText}
//                       />
//                     </div>
//                     <div className="authorDesc w-[calc(100%-12rem)]">
//                       <p>By <Link href={`/author/${calculator?.author?.node?.name}`} className="underline">{calculator?.author?.node?.firstName} {calculator?.author?.node?.lastName}</Link></p>
//                       <p className="small !m-0">
//                         {new Date(calculator?.date).toLocaleDateString('en-US', {
//                           year: 'numeric',
//                           month: 'long',
//                           day: 'numeric',
//                         })}
...
//                       <Link className="redirect" href={`https://www.linkedin.com/shareArticle?mini=true&url=${fullUrl}&title=${calculator.title}&summary=&source=${fullUrl}`} target="_blank">
//                         .
//                       </Link>
//                       <svg
//                         width="40"
...
//                       <Link className="redirect" href={`https://www.facebook.com/sharer.php?u=${fullUrl}&t=${calculator.title}`} target="_blank">
//                         .
//                       </Link>
//                       <svg
//                         width="40"
