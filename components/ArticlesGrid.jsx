...
export default function InsightLanding() {
	...
	return (
		<>
			<section className="ArticlesGrid insightLanding bg-black padding-top-l">
				<div className="container">
					<div className="outer flex lg:flex-wrap">
						<div className="rightCol w-100 lg:mt-[3rem]">
							{filteredTopicList.length == 0 && filteredSolutionList.length == 0 && filteredContentTypeList.length == 0 ? winWidth > 991 ? <h3 className='mb-[5rem]'>Recent Articles</h3> : '' : (
											...
											return [
												<div
													...
													className={`${card.imageSrc ? '' : 'bg-[#E5E4E7]'} ${style.card
															...
															? 'justify-end'
															: 'justify-between'
														} w-[calc(33%-3rem)] xm:w-[calc(50%-3rem)]  mx-[1.5rem] max-h-[45rem] sm:max-h-[40rem] overflow-hidden  min-h-[45rem] sm:min-h-[40rem] mb-[3rem] sm:!w-[calc(100%-3rem)]`}
													id="card"
												>
													{card.redirect === true ? (
														<Link
														...
														>
															<p
																className={`${card.caption
																	? `medium text-white mb-[5rem] sm:mb-[2rem] laptop:mb-[3rem] ${style.medium}`
																	: ''
																	}`}
															>
																{card.caption}
											...
											return (
												<div
													...
													className={`${card.imageSrc ? '' : 'bg-[#E5E4E7]'} ${style.card
														...
														} w-[calc(33%-3rem)] xm:w-[calc(50%-3rem)] mx-[1.5rem] max-h-[45rem] sm:max-h-[34rem] overflow-hidden  min-h-[45rem] sm:min-h-[34rem] mb-[3rem] sm:!w-[calc(100%-3rem)]`}
													id="card"
												>
													{card.redirect === true ? (
														<Link
													...
													>
														{card?.contentType ?
															<span
																className="truncate font-bold py-[0.5rem] px-[1rem] bg-black text-white text-[16px] sm:text-[14px] xs:px-[1rem] xxl-up:text-[1.6rem] inline-block mr-[1rem]"
															>
																{card.contentType}
															</span> : ''
														}
														{card?.topicType ?
															<span
																className="truncate line-clamp-1 max-w-[73%] font-bold py-[0.5rem] px-[1rem] bg-black text-white text-[16px] sm:text-[14px] xs:px-[1rem] xxl-up:text-[1.6rem] inline-block mr-[1rem]"
															>
																{card.topicType}
															</span> : ''
														}
