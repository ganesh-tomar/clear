...
const BrandedBlade = ({ content, pd }) => {
  return (
    <section className={`brandedblade relative sm:!min-h-full ${content?.sectionClass === 'revealParallaxBottom' ? `${Style.brandedblade} h-[100vh] sm:!h-[50vh] sm:mt-[-40px] sm:z-[-1] tablet:h-[80vh] ipad:h-[80vh] ipadmid:h-[80vh] phablet:h-[70vh] phablet:mt-[-30px] laptopSmallMid:h-[70vh] desktopmid:h-[80vh] desktopMidUp:h-[90vh] largedesktop:h-full` : content?.sectionClass === 'revealParallaxTop' ? 'h-[100vh]' : 'h-full sm:z-[1]'} ${content?.sectionClass} ${content?.bgColor} ${pd} `} >
