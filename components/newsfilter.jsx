...
const Newsfilter = () => {
	...
	const tagsClickHandler = (categoryVal, listType) => {
		...
		if (listType === 'category') {
			...
			if (selectedyear!='') {
			const filteredData = NewsData.filter((item) => item.year === selectedyear);
			...
			if (selectedTopic!='') {
			const filteredData = NewsData.filter((item) => item.tab === selectedTopic);
			// console.log(filteredData);
			setFilterData(filteredData);
			}else{
				setFilterData(NewsData);
	...
	return (
		<section className="newsfilter bg-black">
					...
					<div className="left-col w-[29%] lg:w-full lg:mb-[2rem]">
						...
						<div className="filter-menus overflow-hidden w-full  transition-[max-height] duration-300 ">
							<div className="filter-block border-t-[0.1rem] border-[#989898] ">
								...
								<div
									className={`${
										isActive == 1 ? 'max-h-[50rem]' : 'max-h-0'
							...
							<div className="filter-block border-t-[0.1rem] border-[#989898]">
								...
								<div
									className={`${
										isActive == 2 ? 'max-h-[50rem]' : 'max-h-0'
									} optional-wrap transition-all duration-300 overflow-hidden `}
								>
									<ul className="pb-[3rem]">
								...
								<ul>
									{selectedTopic.length > 0 && (
										...
										>
											{selectedTopic}
											<span
												className="absolute flex items-center top-[50%] translate-y-[-50%] right-[1rem] w-[2.4rem] h-[2.4rem]"
								...
								FilterData.slice(startIndex, endIndex).map((item, index) => {
									return (
										<div
											...
											} ${item.blackoverlay ? 'overlayblack ' : ''} ${
											...
											if (
												...
												return (
													<li
														...
														className={`text-black text-[2rem] py-[1rem] px-[1.7rem] sm:px-[1.5rem] sm:py-[0.5rem] sm:text-[1rem] font-[700] flex items-center justify-center leading-[24px] mx-[1rem] transition-all duration-300 hover:text-pink ${
															isCurrent
											...
											if (
												...
												return (
													<li
														...
														key={i + 1}
														onClick={() => handlePageChange(i + 1)}
														className={`text-black text-[2rem] py-[1rem] px-[1.7rem] sm:px-[1.5rem] sm:py-[0.5rem] sm:text-[1rem] font-[700] flex items-center justify-center leading-[24px] mx-[1rem] transition-all duration-200 hover:text-pink ${
															isCurrent
																? 'active text-white hover:text-white bg-pink font-bold'
																: 'bg-gray'
														}`}
												...
												return (
													<li
														key={i + 1}
														onClick={() => handlePageChange(i + 1)}
														className={`text-black text-[2rem] py-[1rem] px-[1.7rem] sm:px-[1.5rem] sm:py-[0.5rem] sm:text-[1rem] font-[700] flex items-center justify-center leading-[24px] mx-[1rempx] transition-all duration-200 hover:text-pink ${
															isCurrent
																? 'active text-white hover:text-white bg-pink font-bold'
																: 'bg-gray'
														}`}
