...
const Contactoverview = () => {
	return (
		<section className="contactoverview min-h-[69rem] padding-md dark__overlay flex-row">
			<div className="bg-img">
				<Image src="/clear-rectangle.png" width={1000} height={1000} alt='img' className='w-full h-full object-cover'/>
			</div>
