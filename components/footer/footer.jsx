...
const Footer = () => {
	return (
		<>
			<div className="footer-clear-digital bg-black pt-32 md:pt-[4rem] z-[2]">
				<div className="container">
					<div className="outer-wrap flex flex-wrap lg-up:pb-[25rem] lg:pb-[10rem] sm:pb-[7rem!important]">
						<div className="item small xl-up:w-[33%] laptop:w-[25%] laptop:mr-[6rem] tablet:w-1/2 phablet:w-1/2 sm:w-full">
							...
							<div className="social-icons flex items-center gap-[2.7rem] sm:gap-[3rem] sm:mt-[3rem]">
								<div
									className={`${styles.icon} icon relative w-[3.5rem] laptop:w-[4rem] h-[3.5rem]`}
								>
									<div className={`${styles.showicon} showicon`}>
										<a
											href="https://www.facebook.com/cleardigitalinc"
											target="_blank"
											className="group"
										>
											...
											<svg
												...
												fill="none"
												xmlns="http://www.w3.org/2000/svg"
												className=" sm:w-[3.5rem] sm:h-[3.5rem]"
											>
												<path
									...
									<div
										className={`${styles.hiddenicon} hiddenicon absolute overflow-hidden top-0 w-0`}
									>
										<a
											href="https://www.facebook.com/cleardigitalinc"
											target="_blank"
								...
								>
									<div className={`${styles.showicon} showicon`}>
										<a
											href="https://www.instagram.com/cleardigitalinc"
											target="_blank"
											className="group"
										>
											<span className="sr-only">Facebook</span>
								...
								>
									<div className={`${styles.showicon} showicon`}>
										<a
											href="https://www.linkedin.com/company/cleardigitalinc"
											target="_blank"
											className="group"
										>
											...
											>
												<path
													...
													fill="#989898"
													className="group-hover:fill-pink transition-all duration-300"
												/>
											</svg>
										</a>
									</div>
								...
								>
									<div className={`${styles.showicon} showicon`}>
										<a
											href="https://twitter.com/cleardigitalinc"
											target="_blank"
											className="group"
										>
							...
							<div className="content-wrap flex sm:flex-wrap">
								...
								<div className="intro w-[70%] laptop:w-[calc(100%-18rem)] sm:w-full sm:pl-0 sm:mt-[20px] pl-[3rem] text-white">
									...
									<p className="mb-[3.2rem] mt-[2rem] sm:mt-[1rem] sm:mb-[2rem]">
										...
										velit lorem ipsum dolor sit amet lorem ipsum.
									</p>
					...
					<div className="wrapper pb-20 sm:pb-[4rem] sm:mb-[4rem] border-b border-white">
			...
			<div className="footer-myrious bg-black pt-20 pb-24 sm:pb-[5rem]">
				<div className="container">
