...
const HomepageHero = () => {
  ...
  const handlespanclick = () => {
    setIsOverlayOpen(false)
        ...
        {/* <div className={`clearnewlogo relative bg-white`}>
        ...
        {/* <div className={`clearnewlogo relative bg-white`} style={{ clipPath: 'url(#svgClipPath)' }}>
          <svg className={`${styles.clearLogoSvg}`} id='clearLogoSvg' viewBox="0 0 111 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
 ...
 */}
  return (
    <section className={`hero__banner grid__parallax height__full flex items-center cursor-pointer`}>
      <div className='absolute w-full h-full top-0 left-0 z-[1]' onClick={handleOverlayClick} data-cursor-expand data-cursor-icon="iconPlay" ></div>
      ...
      </div>
      {
        isOverlayOpen && (
          <div className="overlay fixed top-0 left-0 w-full h-full xl-up:p-[10rem] xl:p-[4rem] bg-black/[0.8] z-[100!important] transition-all duration-300 ease-linear">
            ...
            <span className="group absolute h-[3rem] w-[3rem] right-[1rem] top-[5rem] cursor-pointer" iconMinus onClick={handlespanclick}>
