...
export default function Index() {
	return (
		<Layout>
			<NextSeo
				title="Splunk: The Next Generation Secure Email Cloud"
				description="Splunk is advancing email security by using predictive AI modeling to prevent attacks and ensure humanity prevails over evil."
			/>
