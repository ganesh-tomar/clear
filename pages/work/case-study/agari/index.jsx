...
import { heroBanner, imageBlade, brandedblade, imageGrid, introduction, logoWithContent, redirect, footerCta } from './data.js'
...
export default function Index() {
  ...
  return (
    <Layout>
       <NextSeo
                title="Agari: The Next Generation Secure Email Cloud"
                description="Agari is advancing email security by using predictive AI modeling to prevent attacks and ensure humanity prevails over evil."  
            />
