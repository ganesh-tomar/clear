			...
			<div className="container">
				<div className="wrapper w-full relative flex flex-wrap justify-between">
					{content?.content.map((item, index) => (
						<div Key={index} className={`${index === 1 ? 'lg-up:text-right  lg:block' : ''} ${props === true ? 'lg:w-full' : ''} ${index === 0 && props === true ? 'lg:hidden' : 'sm:hidden'} btnWrap mt-5 sm:w-full sm:mb-[2rem] sm:hidden`}
						 >
							<Link
