      ...
      <div className="container">
        ...
        <div className="accordionWrap">
          {accordionItems.map((item, index) => (
            <div data-cursor-expand data-cursor-icon={activeIndex === index ? "iconMinus" : "iconPlus"} key={index} className="accordion-item relative py-[5rem] border-b border-black sm:py-[3rem]" onClick={() => toggleAccordion(index)}>
              <div
