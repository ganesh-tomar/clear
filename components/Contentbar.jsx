        ...
        <section className="contentbar grid__parallax dark">
            <div className="container">
                <div className="wrapper w-full relative flex flex-wrap ml-[-7.5rem] lg:ml-0">
                    ...
                    <div className="w-[calc(50%-13rem)] starly max-w-[57rem] ml-[9.2rem] max-h-[38rem] bg-[#E5E4E7] py-[5rem] pl-[5rem] pr-[25rem] laptop:pr-[20rem] relative lg:!w-[100%] lg:mx-0 sm:pr-[10rem] xs:pr-[7rem] sm:pl-[2rem] ">
