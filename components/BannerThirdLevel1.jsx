...
export default function BannerThirdLevel1({
	...
	return (
		...
		>
			...
			<div className="container">
				<div
					className={`${max === 'max' ? 'max-w-[141rem]' : 'max-w-[117rem] '} ${blacklogo === true ? 'blacklogo' : ''} ${heart === true ? 'heart' : ''} content-wrap xxl-up:pt-[16.9rem] pt-[16.9rem] laptop:pt-[14rem] lg:pt-[12rem] relative z-[3]  xxl-up:pb-[0] xxl-down:pb-[0] sm:!pt-[80px]`}
				>
